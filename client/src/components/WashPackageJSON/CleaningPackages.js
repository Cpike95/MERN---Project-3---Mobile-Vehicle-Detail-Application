export const CleaningPackages = [
	{
		...
		packageDetailBullets: ['Hand Wash with New microfiber towel', 'Deep Clean Wheels, Tires, Fenders, Gas Cap', 'Air dry with filtered air', 'Dress Tires & Fenders', 'Clean Exterior Glass & Windows', 'Wipe Down Door Jams, Cup Holders, and Center Console', 'Thorough Vacuum', 'Cleaning Interior Glass & Windows', 'Wiping Down Dust Of All Surfaces', 'Steam Cleaning & Shampoo carpert extraction', 'Cleaning & Conditioning Leather & Trim', '(All chemicals used are of high quality & are water based to avoid any damage to vehicle)'],
